      ...
      <div className="text-center">
        ...
        <div className="relative w-32 h-32 mx-auto mb-8 animate-bounce">
          <div className="relative w-full h-full p-3 rounded-2xl bg-gradient-to-br from-slate-800 via-slate-700 to-blue-900 shadow-2xl">
            ...
            <div className="absolute -bottom-1 -left-1 w-3 h-3 bg-gradient-to-br from-slate-500 to-slate-700 rounded-full shadow-lg animate-pulse"></div>
          </div>
        </div>

        {/* Loading Text */}
        <div className="space-y-4">
          <h2 className="text-2xl font-bold text-slate-800 font-primary">Loading...</h2>
          <p className="text-lg text-slate-600 font-primary">Montana's Trusted Handyman</p>
